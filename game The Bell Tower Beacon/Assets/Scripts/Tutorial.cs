...
public class Tutorial : MonoBehaviour
{
    ...
    void InitInstructs()
    {
        ...
        instruct[1] = "In front of every building there is a small zone representing the entrance. Some buildings have more than one entrance.\n\n" +
                        "Note: some buildings have exits that can not be used as entrances.";
        instruct[2] = "To get a new Task the player must go in to the West Quad building and request a task.";
        instruct[3] = "If the player is not sure where a building is, they can pull up the mini map which will show all the buoldings and their relative location.\n\n" +
                        "(arrow points to the minimap icon press to view the map)";
        instruct[4] = "To view the current task please click the information icon.\n\nNote the icon will only be available when there is an active task.";
